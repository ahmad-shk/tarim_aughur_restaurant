...
export function Reservation() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(language === 'de'
        ? `Etwas ist schiefgelaufen. Bitte rufen Sie uns an: ${t("phoneValue")}`
        : `Something went wrong. Please call us: ${t("phoneValue")}`);
    }
          ...
          <div className="">
            ...
            <div className="space-y-3 my-[33px]">
              <div className="flex items-center md:justify-start justify-center gap-[14px]">
                ...
                <a href={`tel:${t("phoneValue")}`} className="">{t("phoneValue")}</a>
              </div>
              <div className="flex items-center md:justify-start justify-center gap-[14px]">
